    ...
    <main>
        <center class="center-content">
            <div class="form-control">
                <form class="container" action="update_user2.php" method="POST" enctype="multipart/form-data">
                    <h2>แก้ไขข้อมูลผู้ใช้</h2><br>

                    <div>
                        
                        <input type="hidden" style="width: 300px;" class="form-control" id="User_ID" name="User_ID"
                            VALUE="<?=$us['User_ID']?>">
                    </div><br>
