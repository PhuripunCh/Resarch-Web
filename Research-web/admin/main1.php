...
<div class="container">
    <main>
        <center><h1>งานวิจัยทั้งหมด</h1></center><br>
        <?php
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <img src="'.$Research_img .' " alt="รูปงานวิจัย">
                  ...
                  <p><a href="index_ad.php?A=1&B=5&id='.$Research_ID.'" class="btn btn-warning">แก้ไขข้อมูล</a></p>
                  <p><button class="delete-button btn btn-danger" data-research-id="'.$row['Research_ID'].'">ลบข้อมูล</button></p>
        </article>';
        }
        ...
        echo '<ul class="pagination">';
            ...
            echo '<li class="page-item"><a class="page-link"
                    href="index_ad.php?A=1&B=6&page=' . ($currentPage - 1) . '">ย้อนกลับ</a></li>';
            }
            for ($i = 1; $i <= $totalPages; $i++) { if ($currentPage==$i) {
                echo '<li class="page-item active"><a class="page-link">' . $i . '</a></li>' ; } else {
                echo '<li class="page-item"><a class="page-link" href="index_ad.php?A=1&B=6&page=' . $i . '">' . $i
                . '</a></li>' ; } } if ($currentPage < $totalPages) {
                echo '<li class="page-item"><a class="page-link" href="index_ad.php?A=1&B=6&page=' . ($currentPage + 1)
                . '">หน้าถัดไป</a></li>' ; } echo '</ul>' ; ?>
