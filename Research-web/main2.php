...
<div class="container">
    <main>
        ...
        if ($currentPage > 1) {
            echo '<li class="page-item"><a class="page-link" href="index.php?P=1&S=3&page=' . ($currentPage - 1) . '">Previous</a></li>';
        }
        for ($i = 1; $i <= $totalPages; $i++) {
            if ($currentPage == $i) {
                echo '<li class="page-item active"><a class="page-link">' . $i . '</a></li>';
            } else {
                echo '<li class="page-item"><a class="page-link" href="index.php?P=1&S=3&page=' . $i . '">' . $i . '</a></li>';
            }
        }
        if ($currentPage < $totalPages) {
            echo '<li class="page-item"><a class="page-link" href="index.php?P=1&S=3&page=' . ($currentPage + 1) . '">Next</a></li>';
        }
        echo '</ul>';
            ?>
    </main>
